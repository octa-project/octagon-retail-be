...
// public ResponseEntity<ResponseModel<BankTransactions>>
// saveBankTransaction(BankTransactions transaction) {
...
// }
// public ResponseEntity<ResponseModel<BankTransactions>>
// updateBankTransaction(BankTransactions update, Long id) {
// BankTransactions transaction =
// bankTransactionRepository.findById(id).orElse(null);
// if (transaction != null) {
...
// true, transactions));
// }
// return ResponseEntity.ok(new ResponseModel<>("500", "Амжилтгүй. %s кодтой
// гүйлгээний мэдээлэл олдсонгүй.".formatted(id), false, null));
// }

// public ResponseEntity<ResponseModel<List<BankTransactions>>> getMany(Date
// startDate, Date endDate) {
// List<BankTransactions> transactions =
// bankTransactionRepository.getMany(startDate,endDate);
...
// id) {
// List<BankTransactions> transactions =
// bankTransactionRepository.getBySaleId(id);
// if (!transactions.isEmpty()) {
// return ResponseEntity.ok(new ResponseModel<>("200", "Амжилттай", true,
// transactions));
// } else {
...
// ахин оролдон уу", false, transaction));
// }
// }
