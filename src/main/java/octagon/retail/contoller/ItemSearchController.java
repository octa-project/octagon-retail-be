...
// public ResponseEntity<ResponseModel<List<ItemCodes>>> getLikeBarcode(String
// itemBarCode) {
// return itemSearchService.getLikeBarcode(itemBarCode);
// }

// @GetMapping("get-like-name")
// public ResponseEntity<ResponseModel<List<ItemCodes>>> getLikeName(String
// itemName) {
// return itemSearchService.getLikeName(itemName);
// }

// @GetMapping("get-like-price")
// public ResponseEntity<ResponseModel<List<ItemCodes>>> getLikePrice(String
// itemPrice) {
