...
public class TransactionController {
    ...
    @GetMapping("get-many")
    public ResponseEntity<ResponseModel<List<Transactions>>> getMany(@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date startDate, @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date endDate){
