...
public class BankTransactionController {
    ...
    @PutMapping("update")
    public ResponseEntity<ResponseModel<BankTransactions>> update(@Valid @RequestBody BankTransactions transaction,
            Long id) {
    ...
    @GetMapping("get-many")
    public ResponseEntity<ResponseModel<List<BankTransactions>>> getMany(
