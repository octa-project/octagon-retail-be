...
public class BankTransactionController {
    ...
    @PostMapping("save")
    public ResponseEntity<ResponseModel<BankTransactions>> save(@Valid @RequestBody BankTransactions transaction) {
        return bankTransactionService.saveBankTransaction(transaction);
    }
    @PutMapping("update")
    public ResponseEntity<ResponseModel<BankTransactions>> update(@Valid @RequestBody BankTransactions transaction, Long id){
    ...
    @GetMapping("get-many")
    public ResponseEntity<ResponseModel<List<BankTransactions>>> getMany(@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date startDate, @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date endDate){
